...
Given I read robots.txt at "dev.timescity.com" as "googlebot"
When I lookup for "http://dev.timescity.com/ahmedabad/barsnclubs"
Then It should not be allowed for crawling

Scenario: Timespoynt is blocked for spiders

Given I read robots.txt at "dev.timescity.com" as "googlebot"
When I lookup for "http://dev.timescity.com/timespoynt"
Then It should not be allowed for crawling

Scenario: 404 page is blocked for spiders

Given I read robots.txt at "dev.timescity.com" as "googlebot"
When I lookup for "http://dev.timescity.com/404.php"
Then It should not be allowed for crawling
...
Given I read robots.txt at "dev.timescity.com" as "googlebot"
When I lookup for "http://dev.timescity.com/estsrp.php?bytags=info@jyotinivas.org"
Then It should not be allowed for crawling
